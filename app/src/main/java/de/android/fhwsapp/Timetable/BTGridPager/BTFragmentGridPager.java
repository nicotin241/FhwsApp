package de.android.fhwsapp.Timetable.BTGridPager;
...
public class BTFragmentGridPager extends ViewPager {
    ...
    public void setStartDay(int day, int week){
        mCurrentIndex = new GridIndex(week, day);
    }
    ...
    public class FragmentGridHorizontalPagerAdapter extends FragmentStatePagerAdapter{
        ...
        public Fragment getItem(int i) {
            ...
            if (vpFragFlag){
                ...
                final BTVerticalPagerFragment vpFragment = new BTVerticalPagerFragment();
